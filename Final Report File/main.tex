...
The synthetic validation further clarifies the statistical properties of our estimators. Overall, the synthetic experiments show that while all estimators recover the true treatment effects reasonably well, covariate-adjusted approaches—particularly the Direct Method and the doubly robust estimator—achieve substantially lower mean squared error than the simple difference-in-means benchmark, highlighting meaningful efficiency gains even in a randomized experimental setting.
