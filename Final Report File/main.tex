...
\begin{tabular}{llcccc}
\hline
Comparison & Outcome & ps mse & mu1 mse & mu0 mse \\
\hline
Mens vs Control 
...
The mse analysis shown in table 6 also provides diagnostic measures for propensity score and outcome regression models. The propersity score mean squared error (PS MSE) is small across all treatment comparisons and outcomes, indicating a fully randomized design of the email experiment. The outcome regression MSEs differ substantially across outcomes reflecting heterogeneity in the outcome variability rather than model mispecification and does not affect validity of the DR results. Spending notably has a much larger MSE consistent with the heavy tailed nature of spending behavior as a majority do not purchase items which will be further explored in the CATE analysis while visit and conversion have small MSEs showing stable predictions across all users. Overall, these diagnostics support the use of DR estimator as an efficiency enhancing approach in this setting rather than bias correction.
